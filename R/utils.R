...
#'
#' This functions can be used to validate the input to functions
#'
#' @param x
...
#' corresponding character required by APA guidelines (6th edition).
#'
#' @param x Chracter.
#'
#' @examples
...
#'
#' Creates a character string from an object with attribute
#'
#' @param x Numeric. Either a \code{vector} of length 2 with attribute \code{conf.level} or a two-column \code{matrix} and confidence region
#' bounds as column names (e.g. "2.5 %" and "97.5 %") and coefficient names as row names.
#' @param conf_level Numeric. Vector of length 2 giving the lower and upper bounds of the confidence region in case they cannot be determined
#' from column names or attributes of \code{x}.
#' @param ... Arguments to pass to \link{\code{printnum}}.
