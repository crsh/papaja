...
theme_apa <- function(base_size = 14, base_family = "", box = FALSE) {
  adapted_theme <- ggplot2::theme_bw(base_size, base_family) +
    ggplot2::theme(
      ...
      , axis.title.x = ggplot2::element_text(margin = ggplot2::margin(ggplot2::rel(18), 0, 0, 0))
      , axis.title.y = ggplot2::element_text(margin = ggplot2::margin(0, ggplot2::rel(18), 0, 0))
      , axis.ticks.length = ggplot2::unit(ggplot2::rel(6), "points")
      , axis.text = ggplot2::element_text(size = ggplot2::rel(0.9))
      , axis.text.x = ggplot2::element_text(margin = ggplot2::margin(ggplot2::rel(6), 0, 0, 0))
      , axis.text.y = ggplot2::element_text(margin = ggplot2::margin(0, ggplot2::rel(8), 0, 0))
