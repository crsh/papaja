#' Sinaplots for factorial designs that conform to APA guidelines
#'
#' Wrapper function that creates one or more sinaplots from a \code{data.frame} containing data from
...
apa_sinaplot <- function(data, ...) {
  UseMethod("apa_sinaplot", data)
}
...
apa_sinaplot.afex_aov <- function(
  data
  , tendency = mean
  , dispersion = conf_int
  , fun_aggregate = mean
