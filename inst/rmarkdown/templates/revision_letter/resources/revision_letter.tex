...
$if(manuscript-id)${\Large\bf Author response to reviews of}\\[1em]$manuscript-id$\\ \\$endif$
...
$if(manuscript-id)$\hfill {\bfseries [RC]\hspace{0.5em}} \textbf{Reviewer comment}%
%\(\qquad\) AR:\hspace{0.5em} Author response%
\(\qquad \fcolorbox{black!25!white}{white}{\hspace{0.25em}Manuscript text\hspace{0.25em}}\)$manuscript-id$\\ \\$endif$
