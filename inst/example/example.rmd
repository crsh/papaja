...
The package uses the \LaTeX document class [apa6](https://www.ctan.org/pkg/apa6) and a .docx-reference file, so you can create PDF documents, or Word documents if you have to.
...
See the [great book on `bookdown`](https://pkg.yihui.org/bookdown/cross-references.html) for details.
