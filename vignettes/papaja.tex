...
\hypersetup{
  ...
  pdflang={en-EN},
  pdfkeywords={\xmpquote{APA style, R, knitr, R markdown, papaja}},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
For a comprehensive introduction and installation instructions, see the current draft of the \href{https://frederikaust.com/papaja_man/}{\textbf{papaja} manual}.\footnote{If you have a specific question that is not answered in the manual, feel free to ask a question on Stack Overflow using the \href{https://stackoverflow.com/questions/tagged/papaja}{\textbf{papaja} tag}.
  If you believe you have found a bug or would like to request a new feature, \href{https://github.com/crsh/papaja/issues}{open an issue} on Github and provide a \href{https://stackoverflow.com/help/minimal-reproducible-example}{minimal complete verifiable example}.}
...
Several seasoned technical solutions, such as software containers or a virtual machine, exist (Grüning et al., 2018; Piccolo \& Frampton, 2016).\footnote{\textbf{papaja} can be readily combined with these tools as documented in the section on \href{https://frederikaust.com/papaja_man/tips-and-tricks.html\#reproducible-software-environments}{reproducible software environments} in the \textbf{papaja} manual.}
...
\textbf{papaja}, and \href{https://frederikaust.com/papaja_man/introduction.html\#document-compilation}{the software it builds on}, provides researchers with the tools to create dynamic submission-ready manuscripts in the widely used APA style.
...
Once \textbf{papaja} and all other \href{https://frederikaust.com/papaja_man/introduction.html\#software-requirements}{required software} is installed, the APA template is available through the RStudio menu, see Figure~\ref{fig:rstudio}.
...
{\centering \includegraphics[width=4.27in]{../inst/images/template_selection} 
...
For a comprehensive overview of other formatting options please refer to the \href{https://frederikaust.com/papaja_man/r-markdown-components.html\#rendering-options}{\textbf{papaja} manual}.
...
This is why some \textbf{papaja} features are only available for PDF documents, for example, see the summary of \href{https://frederikaust.com/papaja_man/r-markdown-components.html\#rendering-options}{rendering options} in the manual.
Also, DOCX documents require some \href{https://frederikaust.com/papaja_man/limitations.html\#microsoft-word-documents}{limited manual work} before they fully comply with APA guidelines.
...
If you use VSCode with the \href{https://marketplace.visualstudio.com/items?itemName=REditorSupport.r}{R extension} or RStudio without the Visual Editor, the add-in provided in \href{https://github.com/crsh/citr}{\textbf{citr}} serves a similar purpose.
...
R [Version 4.5.3\; @R-base] and the R-packages *afex* [Version 1.5.0\; @R-afex], *dplyr* [Version 1.2.1\; @R-dplyr], *ggforce* [Version 0.5.0\; @R-ggforce], *ggplot2* [Version 4.0.0\; @R-ggplot2], *lme4* [Version 1.1.37\; @R-lme4], *Matrix* [Version 1.7.4\; @R-Matrix], *papaja* [Version 0.1.4\; @R-papaja], and *tinylabels* [Version 0.2.5\; @R-tinylabels]
\end{Verbatim}
...
For a comprehensive introduction to \textbf{papaja}, check out the current draft of the \href{https://frederikaust.com/papaja_man/}{\textbf{papaja} manual}.
...
If you believe you have found a bug or you want to request a new feature, \href{https://github.com/crsh/papaja/issues}{open an issue} on Github and provide a \href{https://stackoverflow.com/help/minimal-reproducible-example}{minimal complete verifiable example}.
...
Moreover, a \href{https://frederikaust.com/papaja_man/published-manuscripts.html}{collection of papers} written with \textbf{papaja,} including the corresponding R Markdown files, is listed in the manual.
...
Before working on a contribution, please review our brief \href{https://github.com/crsh/papaja/blob/master/.github/CONTRIBUTING.md}{contributing guidelines} and \href{https://github.com/crsh/papaja/blob/main/CODE_OF_CONDUCT.md}{code of conduct}.
...
\bibitem[\citeproctext]{ref-american_psychological_association_publication_2010}
...
\bibitem[\citeproctext]{ref-artner_reproducibility_2020}
...
\bibitem[\citeproctext]{ref-cacioppo_social_2015}
...
\bibitem[\citeproctext]{ref-donoho_invitation_2010}
...
\bibitem[\citeproctext]{ref-eubank_lessons_2016}
...
\bibitem[\citeproctext]{ref-gruning_practical_2018}
...
\bibitem[\citeproctext]{ref-hardwicke_data_2018}
...
\bibitem[\citeproctext]{ref-henson_inferring_2016}
...
\bibitem[\citeproctext]{ref-hutson_artificial_2018}
...
\bibitem[\citeproctext]{ref-nuijten_prevalence_2016}
...
\bibitem[\citeproctext]{ref-piccolo_tools_2016}
...
\bibitem[\citeproctext]{ref-xie_r_2018}
Xie, Y., Allaire, J. J., \& Grolemund, G. (2018). \emph{R Markdown: The Definitive Guide}. Boca Raton: Taylor \& Francis, CRC Press. Retrieved from \url{https://pkg.yihui.org/rmarkdown-book/}
