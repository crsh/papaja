...
To facilitate typesetting term names for reporting, there is another internal function `papaja:::beautify_terms()`.

```{r prettify-terms}
papaja::beautify_terms(mod_terms, standardized = TRUE)
```
