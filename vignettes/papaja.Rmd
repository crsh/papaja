...
For a comprehensive introduction and installation instructions, see the current draft of the [**papaja** manual](http://frederikaust.com/papaja_man/).[^1]
...
[^2]: **papaja** can be readily combined with these tools as documented in the section on [reproducible software environments](http://frederikaust.com/papaja_man/tips-and-tricks.html#reproducible-software-environments) in the **papaja** manual.
...
For a comprehensive overview of other formatting options please refer to the [**papaja** manual](http://frederikaust.com/papaja_man/r-markdown-components.html#rendering-options).
...
This is why some **papaja** features are only available for PDF documents, for example, see the summary of [rendering options](http://frederikaust.com/papaja_man/r-markdown-components.html#rendering-options) in the manual.
Also, DOCX documents require some [limited manual work](http://frederikaust.com/papaja_man/limitations.html#microsoft-word-documents) before they fully comply with APA guidelines.
