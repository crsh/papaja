...
**papaja** provides [**rmarkdown**](https://rmarkdown.rstudio.com/) [@xie_r_2018] templates to create DOCX documents and PDF documents---using \LaTeX document class [`apa6`](https://www.ctan.org/pkg/apa6).
...
If you use VSCode with the [R extension](https://marketplace.visualstudio.com/items?itemName=REditorSupport.r) or RStudio without the Visual Editor, the add-in provided in [**citr**](https://github.com/crsh/citr) serves a similar purpose.
