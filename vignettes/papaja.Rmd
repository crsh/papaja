...
A corrected reanalysis indicated that, in fact, the opposite was the case---the treatment appeared to be effective and decrease mortality.
...
For every fourht of those results that were irreproducible, the results of the reproduction attempt cast doubt on the statistical inference,
i.e. the results were no longer statistically significant.
...
Several seasoned solutions, such as software containers or a virtual machine, exist [@piccolo_tools_2016; @gruning_practical_2018].[^2]
...
Quantitative analyses and reporting are mostly done with separate software.
