...
Yet, irreproducible results widely prevalent.
Computational reproducibility is threatened by uncountable sources of errors, but among the most common problems are incomplete or incorrect reporting of statistical procedures and results [@artner_reproducibility_2020].
**papaja** was designed to address these problems.
The package is tailored to authors of scientific manuscripts that must adhere to the guidelines of the American Psychological Society [APA, 6th edition, @american_psychological_association_publication_2010].
**papaja** provides [**rmarkdown**](http://rmarkdown.rstudio.com/) [@xie_r_2018] templates to create DOCX documents and PDF documents---using \LaTeX document class [`apa6`](http://www.ctan.org/pkg/apa6).
...
Copy-paste-reporting underlies and contributes to several of the most common causes for computational irreproducibility: Rounding errors, incorrect labeling of statistical results, typos, and inserting results of a different analysis [pp. 12-13, @artner_reproducibility_2020].
...
The motivation to avoid such errors should already be high because the reputational cost of errata and retractions due to irreproducible results is substantial.
Even researchers that open their data (and analysis code) to the public or anticipate systematic editorial scrutiny report irreproducible results [@obels_analysis_2020; @eubank_lessons_2016; @hardwicke_data_2018].
...
**papaja**, and [the software it builds on](http://frederikaust.com/papaja_man/introduction.html#document-compilation), provides researchers with the tools to create dynamic submission-ready manuscripts in the widely used APA-style.
