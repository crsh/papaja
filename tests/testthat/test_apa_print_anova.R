...
test_that(
  ...
  , {
    ...
    expect_that(ow_aov_output$stat$Dosage, equals("$F(2, 15) = 8.79$, $MSE = 24.25$, $p = .003$"))
    ...
    expect_that(ow_aov_output$full$Dosage, equals("$F(2, 15) = 8.79$, $MSE = 24.25$, $p = .003$, $\\eta^2_G = .540$"))

    # table
    expect_that(ow_aov_output$table, is_a("data.frame"))
    expect_that(nrow(ow_aov_output$table), equals(1))
    expect_that(colnames(ow_aov_output$table), equals(c("Effect", "$F$","$df_1$", "$df_2$", "$MSE$", "$p$", "$\\eta^2_G$")))
    ...
    expect_that(ow_afex_aov_output$stat$Intercept, equals("$F(1, 15) = 487.23$, $MSE = 24.25$, $p < .001$"))
    expect_that(ow_afex_aov_output$stat$Dosage, is_a("character"))
    expect_that(ow_afex_aov_output$stat$Dosage, equals("$F(2, 15) = 8.79$, $MSE = 24.25$, $p = .003$"))
    ...
    expect_that(ow_afex_aov_output$full$Intercept, equals("$F(1, 15) = 487.23$, $MSE = 24.25$, $p < .001$, $\\eta^2_G = .970$"))
    expect_that(ow_afex_aov_output$full$Dosage, is_a("character"))
    expect_that(ow_afex_aov_output$full$Dosage, equals("$F(2, 15) = 8.79$, $MSE = 24.25$, $p = .003$, $\\eta^2_G = .540$"))

    # table
    expect_that(ow_afex_aov_output$table, is_a("data.frame"))
    expect_that(nrow(ow_afex_aov_output$table), equals(2))
    expect_that(colnames(ow_afex_aov_output$table), equals(c("Effect", "$F$", "$df_1$", "$df_2$", "$MSE$", "$p$", "$\\eta^2_G$")))
...
test_that(
  ...
  , {
    ...
    expect_that(tw_aov_output$stat$Gender, equals("$F(1, 12) = 2.95$, $MSE = 25.94$, $p = .111$"))
    expect_that(tw_aov_output$stat$Dosage, is_a("character"))
    expect_that(tw_aov_output$stat$Dosage, equals("$F(1, 12) = 0.20$, $MSE = 25.94$, $p = .666$"))
    expect_that(tw_aov_output$stat$Gender_Dosage, is_a("character"))
    expect_that(tw_aov_output$stat$Gender_Dosage, equals("$F(1, 12) = 0.00$, $MSE = 25.94$, $p = .962$"))
    ...
    expect_that(tw_aov_output$full$Gender, equals("$F(1, 12) = 2.95$, $MSE = 25.94$, $p = .111$, $\\eta^2_G = .197$"))
    expect_that(tw_aov_output$full$Dosage, is_a("character"))
    expect_that(tw_aov_output$full$Dosage, equals("$F(1, 12) = 0.20$, $MSE = 25.94$, $p = .666$, $\\eta^2_G = .016$"))
    expect_that(tw_aov_output$full$Gender_Dosage, is_a("character"))
    expect_that(tw_aov_output$full$Gender_Dosage, equals("$F(1, 12) = 0.00$, $MSE = 25.94$, $p = .962$, $\\eta^2_G = .000$"))

    # table
    expect_that(tw_aov_output$table, is_a("data.frame"))
    expect_that(nrow(tw_aov_output$table), equals(3))
    expect_that(colnames(tw_aov_output$table), equals(c("Effect", "$F$","$df_1$", "$df_2$", "$MSE$", "$p$", "$\\eta^2_G$")))
    ...
    expect_that(tw_afex_aov_output$stat$Intercept, equals("$F(1, 12) = 121.99$, $MSE = 25.94$, $p < .001$"))
    expect_that(tw_afex_aov_output$stat$Gender, is_a("character"))
    expect_that(tw_afex_aov_output$stat$Gender, equals("$F(1, 12) = 2.95$, $MSE = 25.94$, $p = .111$"))
    expect_that(tw_afex_aov_output$stat$Dosage, is_a("character"))
    expect_that(tw_afex_aov_output$stat$Dosage, equals("$F(1, 12) = 0.20$, $MSE = 25.94$, $p = .666$"))
    expect_that(tw_afex_aov_output$stat$Gender_Dosage, is_a("character"))
    expect_that(tw_afex_aov_output$stat$Gender_Dosage, equals("$F(1, 12) = 0.00$, $MSE = 25.94$, $p = .962$"))
    ...
    expect_that(tw_afex_aov_output$full$Intercept, equals("$F(1, 12) = 121.99$, $MSE = 25.94$, $p < .001$, $\\eta^2_G = .910$"))
    expect_that(tw_afex_aov_output$full$Gender, is_a("character"))
    expect_that(tw_afex_aov_output$full$Gender, equals("$F(1, 12) = 2.95$, $MSE = 25.94$, $p = .111$, $\\eta^2_G = .197$"))
    expect_that(tw_afex_aov_output$full$Dosage, is_a("character"))
    expect_that(tw_afex_aov_output$full$Dosage, equals("$F(1, 12) = 0.20$, $MSE = 25.94$, $p = .666$, $\\eta^2_G = .016$"))
    expect_that(tw_afex_aov_output$full$Gender_Dosage, is_a("character"))
    expect_that(tw_afex_aov_output$full$Gender_Dosage, equals("$F(1, 12) = 0.00$, $MSE = 25.94$, $p = .962$, $\\eta^2_G = .000$"))

    ## table
    expect_that(tw_afex_aov_output$table, is_a("data.frame"))
    expect_that(nrow(tw_afex_aov_output$table), equals(4))
    expect_that(colnames(tw_afex_aov_output$table), equals(c("Effect", "$F$", "$df_1$", "$df_2$", "$MSE$", "$p$", "$\\eta^2_G$")))
...
test_that(
  ...
  , {
    ...
    expect_that(rm_aov_output$stat$Valence, equals("$F(2, 8) = 189.11$, $MSE = 5.37$, $p < .001$"))
    ...
    expect_that(rm_aov_output$full$Valence, equals("$F(2, 8) = 189.11$, $MSE = 5.37$, $p < .001$, $\\eta^2_G = .932$"))
    ...
    expect_that(rm_afex_anova.mlm_output$full$Valence, equals("$F(1.15, 4.6) = 189.11$, $MSE = 9.34$, $p < .001$, $\\eta^2_G = .932$"))

    rm_afex_anova.mlm_output <- apa_print(rm_afex_aov$Anova, correction = "HF")
    expect_that(rm_afex_anova.mlm_output$full$Valence, equals("$F(1.32, 5.26) = 189.11$, $MSE = 8.16$, $p < .001$, $\\eta^2_G = .932$"))
...
test_that(
  ...
  , {
    ...
    expect_that(tw_rm_aov_output$stat$Task, equals("$F(1, 4) = 7.35$, $MSE = 4.08$, $p = .054$"))
    expect_that(tw_rm_aov_output$stat$Valence, is_a("character"))
    expect_that(tw_rm_aov_output$stat$Valence, equals("$F(2, 8) = 1.46$, $MSE = 3.36$, $p = .288$"))
    expect_that(tw_rm_aov_output$stat$Task_Valence, is_a("character"))
    expect_that(tw_rm_aov_output$stat$Task_Valence, equals("$F(2, 8) = 0.29$, $MSE = 2.41$, $p = .755$"))
    ...
    expect_that(tw_rm_aov_output$full$Task, equals("$F(1, 4) = 7.35$, $MSE = 4.08$, $p = .054$, $\\eta^2_G = .068$"))
    expect_that(tw_rm_aov_output$full$Valence, is_a("character"))
    expect_that(tw_rm_aov_output$full$Valence, equals("$F(2, 8) = 1.46$, $MSE = 3.36$, $p = .288$, $\\eta^2_G = .023$"))
    expect_that(tw_rm_aov_output$full$Task_Valence, is_a("character"))
    expect_that(tw_rm_aov_output$full$Task_Valence, equals("$F(2, 8) = 0.29$, $MSE = 2.41$, $p = .755$, $\\eta^2_G = .003$"))
