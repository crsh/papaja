...
test_that(
  ...
  , {
    ...
    expect_identical(colnames(ow_aov_output$table), c("Effect", "F","df1", "df2", "MSE", "p", "ges"))
    expect_identical(unname(unlist(variable_label(ow_aov_output$table))), c("Effect", "$F$","$\\mathit{df}_1$", "$\\mathit{df}_2$", "$\\mathit{MSE}$", "$p$", "$\\hat{\\eta}^2_G$"))
    ...
    expect_apa_results(ow_afex_aov_output)
    ...
    expect_identical(colnames(ow_afex_aov_output$table), c("Effect", "F", "df1", "df2", "MSE", "p", "ges"))
    expect_identical(unname(unlist(variable_label(ow_afex_aov_output$table))), c("Effect", "$F$", "$\\mathit{df}_1$", "$\\mathit{df}_2$", "$\\mathit{MSE}$", "$p$", "$\\hat{\\eta}^2_G$"))
    expect_identical(
    ...
    expect_apa_results(ow_aov_output)
    expect_identical(ow_aov_output$est$Dosage, "$\\hat{\\eta}^2_p = .540$, $\\hat{\\eta}^2_G = .540$")
  }
)
...
test_that(
  ...
  , {
    ...
    expect_apa_results(tw_aov_output)
    ...
    expect_identical(colnames(tw_aov_output$table), c("Effect", "F","df1", "df2", "MSE", "p", "ges"))
    expect_identical(unname(unlist(variable_label(tw_aov_output$table))), c("Effect", "$F$","$\\mathit{df}_1$", "$\\mathit{df}_2$", "$\\mathit{MSE}$", "$p$", "$\\hat{\\eta}^2_G$"))
    expect_identical(
    ...
    expect_apa_results(tw_afex_aov_output)
...
test_that(
  ...
  , {
    ...
    expect_apa_results(rm_aov_output)
...
test_that(
  ...
  , {
    ...
    expect_apa_results(tw_rm_aov_output)
...
test_that(
  ...
  , {
    ...
    # todo: remove column `$group` and nested reporting strings
    expect_apa_results(levene_test_output)
