...
\NormalTok{glm.D93 <-}\StringTok{ }\KeywordTok{glm}\NormalTok{(counts ~}\StringTok{ }\NormalTok{outcome +}\StringTok{ }\NormalTok{treatment, }\DataTypeTok{family =} \KeywordTok{poisson}\NormalTok{())}

\KeywordTok{apa_table}\NormalTok{(}
  \KeywordTok{apa_print}\NormalTok{(glm.D93)$table}
