...
\caption{\label{tab:unnamed-chunk-40}0 Single row table.}
\small{
\begin{tabular}{lrr}
\toprule
...
\begin{center}
\begin{threeparttable}
\caption{\label{tab:unnamed-chunk-40}1 A small table.}
\small{
\begin{tabular}{lrr}
\toprule
 & \multicolumn{1}{c}{speed} & \multicolumn{1}{c}{dist}\\
...
\begin{center}
\begin{threeparttable}
\caption{\label{tab:unnamed-chunk-41}2 A merged table (list of two) with added stub heading. Not escaped.}
\begin{tabular}{lrr}
\toprule
...
\begin{center}
\begin{threeparttable}
\caption{\label{tab:unnamed-chunk-42}3 A 'merged' table (list of one) with added stub heading.}
\begin{tabular}{lrr}
\toprule
Desciptives & \multicolumn{1}{c}{speed} & \multicolumn{1}{c}{dist}\\
\midrule
...
\begin{center}
\begin{threeparttable}
\caption{\label{tab:unnamed-chunk-42}4 Test if simple row numbers are omitted from table.}
\begin{tabular}{lr}
\toprule
...
\begin{center}
\begin{threeparttable}
\caption{\label{tab:unnamed-chunk-42}5 Test if simple row numbers are omitted from merged table (list of two).}
\begin{tabular}{lr}
\toprule
speed & \multicolumn{1}{c}{dist}\\
\midrule
...
\begin{center}
\begin{threeparttable}
\caption{\label{tab:unnamed-chunk-43}6 Test of column spanner and stub indenting.}
\begin{tabular}{lrr}
\toprule
...
\caption{\label{tab:unnamed-chunk-44}7 Test of midurles and landscape mode and named stub indentation.}\\
\toprule
 & \multicolumn{2}{c}{Measure}  &  &\\
\cmidrule(r){2-3}
...
\end{TableNotes}
\begin{longtable}{lrrlr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:unnamed-chunk-45}8 A long table.}\\
\toprule
 & \multicolumn{2}{c}{Measure}  &  &\\
\cmidrule(r){2-3}
Desciptives & \multicolumn{1}{c}{Mean} & \multicolumn{1}{c}{SD} & \multicolumn{1}{c}{Min} & \multicolumn{1}{c}{Max}\\
...
\end{TableNotes}
\begin{longtable}{lrrlr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:unnamed-chunk-46}9 A long table in landscape mode.}\\
\toprule
 & \multicolumn{2}{c}{Measure}  &  &\\
\cmidrule(r){2-3}
Desciptives & \multicolumn{1}{c}{Mean} & \multicolumn{1}{c}{SD} & \multicolumn{1}{c}{Min} & \multicolumn{1}{c}{Max}\\
