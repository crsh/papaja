...
dependency_graph_df$importance <- dependency_graph_df$importance / max(dependency_graph_df$importance)
dependency_graph_df$importance <- abs(1 - dependency_graph_df$importance)
dependency_graph_df$importance[dependency_graph_df$importance == 0] <- 0.1


dependency_graph_df %>%
  ggplot(aes(x = x, y = y, xend = xend, yend = yend)) +
  geom_nodes(aes(color = n_dependencies), size = 7, alpha = 0.4) +
