...
To use **papaja** you need either a recent version of [RStudio](http://www.rstudio.com/) or [pandoc](http://johnmacfarlane.net/pandoc/).
...
out <- lm(Sepal.Width ~ Sepal.Length + Petal.Width + Petal.Length, data = iris) |>
  apa_print()
colnames(out$table) <- variable_labels(out$table)
